                            ...
                            foreach ($applicationList as $list) {
                                    ...
                                    <tr>
                                       ...
                                       <td>
                                        ...
                                        <button type="button" id="<?php echo $list['user_id'];?>" class="btn ripple btn-sm btn-success btn-icon " data-bs-placement="bottom" data-bs-toggle="tooltip" title="View"> <a href="<?php echo base_url('application-preview/').$list['LoginId'];?>"><i class="fa fa-eye tx-15 text-white"></i></a></button>
