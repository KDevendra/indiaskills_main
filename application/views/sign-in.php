<html lang="en">
   ...
   <body class="ltr main-body leftmenu error-1">
      ...
      <div id="global-loader" style="display: none;"><img src="<?php echo base_url('')?>include/img/logo.png" class="loader-img" alt="Loader" /></div>
                  ...
                  <div class="row row-sm">
                     ...
                     <div class="col-lg-6 col-xl-7 col-xs-12 col-sm-12 login_form">
                        <div class="main-container container">
                           <div class="row row-sm">
                              <div class="card-body">
                                 <h4 class="text-center mb-4" style="line-height: 30px;"><b>Signin</b></h4>
                                 ...
                                 <form id="sign-in">
                                    ...
                                    <button type="submit" id="submitBtn" class="btn ripple btn-main-primary btn-block"><span class="loader"></span> Sign In</button>
                                 </form>
