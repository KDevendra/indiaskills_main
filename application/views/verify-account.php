                        ...
                        <div class="row row-sm">
                           <div class="card-body">
                              ...
                              <?php
                                 ...
                                 echo '<div class="alert alert-primary" role="alert">Verification code sent on <b>' . $hiddenEmail . '</b>
                                 </div>
                                 '; ?>
                              <form id="verify-account">
                                 <div class="form-group text-start">
                                    ...
                                    <input class="form-control" placeholder="Enter Verification Code" name="activationCode" type="text" />
                                 ...
                                 <button type="submit" id="submitBtn" class="btn ripple btn-main-primary btn-block"><span class="loader"></span> Verify</button>
                              </form>
             ...
             $("#verify-account").validate({
                 ...
                 messages: {
                     activationCode: {
                         ...
                         minlength: "Activation code must be at least 6 characters long",
                         maxlength: "Activation code must not exceed 6 characters",
                     },
                     captcha_code: {
